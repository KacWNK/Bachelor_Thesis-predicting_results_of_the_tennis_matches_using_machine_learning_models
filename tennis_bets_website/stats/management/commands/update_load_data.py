    ...
    def handle(self, *args, **kwargs):
        ...
        for _, row in players_df.iterrows():
            try:
                ...
                print(f"Error processing player_id {row['player_id']}: {str(e)}")
            ...
            try:
                ...
                Match.objects.update_or_create(
                    ...
                    defaults={
                        ...
                        'scheduled': clean_value(row['scheduled'])
                    }
                )
            ...
            try:
                ...
                PreMatchStats.objects.update_or_create(
                    ...
                    defaults={
                        ...
                        'winner_CO_1st_serve_return_win_pct_avg': clean_value(
                            row['winner_CO_1st_serve_return_win_pct_avg']),
                        'loser_CO_1st_serve_return_win_pct_avg': clean_value(
                            row['loser_CO_1st_serve_return_win_pct_avg']),
                        ...
                        'winner_CO_2nd_serve_return_win_pct_avg': clean_value(
                            row['winner_CO_2nd_serve_return_win_pct_avg']),
                        'loser_CO_2nd_serve_return_win_pct_avg': clean_value(
                            row['loser_CO_2nd_serve_return_win_pct_avg']),
                        ...
                        'winner_total_wins_tournament_history': clean_value(
                            row['winner_total_wins_tournament_history']),
                        'winner_total_losses_tournament_history': clean_value(
                            row['winner_total_losses_tournament_history']),
                        'loser_total_wins_tournament_history': clean_value(row['loser_total_wins_tournament_history']),
                        'loser_total_losses_tournament_history': clean_value(
                            row['loser_total_losses_tournament_history']),
                    }
                )
